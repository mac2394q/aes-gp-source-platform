                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active parrafo text-black">Fase de Diagnóstico
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form">
                                        ...
                                        <h2 class="form-section"><i class="fa fa-id-card-alt"></i>
                                            Gestión Proyecto - Fase Diagnóstico
                                        </h2>
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row mx-auto last">
                                                    ...
                                                    <div class="col-md-9">
                                                        <?php
                                                    if(rutas::validarRutas( DOCUMENTS_SERVER."documentos/trabajo/".$_GET['id']."/planeacion_diagnostico.pdf") == "200"){
                                                        echo " <div class='badge badge-success round'>Archivo Cargado</div>";
                                                    }
                                                    
                                                    ?>
                                                        <a target="_blank"
                                                            href="<?php echo DOCUMENTS_SERVER."documentos/trabajo/".$_GET['id']."/planeacion_diagnostico.pdf"; ?>"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row mx-auto last">
                                                    ...
                                                    <div class="col-md-9">
                                                        <?php
                                                    if(rutas::validarRutas( DOCUMENTS_SERVER."documentos/trabajo/".$_GET['id']."/reporte.pdf") == "200"){
                                                        echo " <div class='badge badge-success round'>Archivo Cargado</div>";
                                                    }
                                                    
                                                    ?>
                                                        <a target="_blank"
                                                            href="<?php echo DOCUMENTS_SERVER."documentos/trabajo/".$_GET['id']."/reporte.pdf"; ?>"
                                                            class="btn capa text-white round waves-effect waves-light">
                                                            <i class="fa fa-download fa-2x"></i>&nbsp;Descargar
                                                            Documento
                                                        </a>
                                        ...
                                        <?php if($_SESSION['rol'] == "ADMINISTRADOR" || $_SESSION['rol'] == "LIDER OEA" || $_SESSION['rol'] == "ASISTENTE" ){ ?>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <?php 
                                                        usuarioController::listadoUsuariosEspecialistasDiag($objTrabajo->getId_usuario_diagnostico(),$_GET['id']);
                                                    ?>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <button type="button" id="asignarUsuarioDiagnostico"
                                            ...
                                            <br>
                                            <div class="col-md-12">
                                            <?php  if(!is_null($objTrabajo->getId_usuario_diagnostico())){
                                                $objEmpleado =usuarioController::usuarioId($objTrabajo->getId_usuario_diagnostico());
                                                ?>
