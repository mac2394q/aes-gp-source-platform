...
<body class="vertical-layout vertical-menu-modern material-vertical-layout material-layout 2-columns  bg-white "
    data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" style="zoom:65%;">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active parrafo text-black"><a class="text-black" href="<?php echo "verFicha.php?id=".$_GET['id']; ?>">Ver Ficha de Trabajo</a>
                                    </li>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="text" class="form-control text-black  parrafo"
                                                        placeholder=". . ." name="programacion" id="programacion"
                                                        value="">
                                                </div>
                                            </div>
                                    ...
                                    <div class="form">
                                        <div class="form-body">
                                            ...
                                            <div id="ocultar" class="row">
                                                <div class="col-md-4">
                                                    <!-- <div class="form-group">
                                                        <label for="">
                                                            <h5 class="card-title parrafo">
                                                                <li class="fa fa-calendar-alt fa-2x"></li>&nbsp;Fecha de Busqueda
                                                            </h5>
                                                        </label>
                                                    ...
                                                    <div class="form-group">
                                                        <?php trabajoController::selectorFechas($_GET['idproyecto']); ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <button type="button" id="busquedaActa"
                                                                class="btn text-white round capa waves-effect waves-light">
                                                                <i class="fa fa-search fa-2x"></i>&nbsp;Generar
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $(document).on('click', '#f1', function (e) {
            document.getElementsByName("programacion" )[0].value = $('#f1').val();
        });
    </script>
</body>
<!-- END: Body-->
