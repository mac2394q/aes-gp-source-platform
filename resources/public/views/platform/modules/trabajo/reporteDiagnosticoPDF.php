        ...
        <div class="content-wrapper">
            <div class="content-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <br>
                                                        <h2 class="form-section parrafo"><i class="fa fa-chart-pie fa-2x"></i>&nbsp;VERIFICACIÓN DE REQUISITOS OEA</h2>
                                                    </div>
                                                    <div class="card-content collapse show">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 ">
                        <div class="card text-black">
                        <h2 class="form-section parrafo"><i class="fa fa-clipboard fa-2x"></i>&nbsp;RESUMEN EJECUTIVO </h2>
                        ...
                        <div class="row">
                            <div class="form-group mb-1  col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                ...
                                ?>
                                <textarea class="form-control card-title parrafo text-black " id="actividades" style="border: 1px solid #cdcdcd;" name="actividades" rows="4" cols="120"><?php echo $actividad; ?></textarea>
                            </div>
                            <div class="form-group mb-1  col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                <label>
                                    <h5 class="card-title parrafo text-black">
                                ...
                                ?>
                                <textarea class="form-control card-title parrafo text-black " id="aspectos" style="border: 1px solid #cdcdcd;" name="aspectos" rows="4" cols="120"><?php echo $actividad; ?></textarea>
                            </div>
                            <br><br><br><br><br>
                            <div class=" form-group mb-1 col-sm-12 col-md-12 col-xs-12  col-lg-12">
                                ...
                                ?>
                                <textarea class="form-control card-title parrafo text-black" id="hallasgoz" style="border: 1px solid #cdcdcd;" name="hallasgoz" rows="4" cols="120"><?php echo $actividad; ?></textarea>
                            </div>
                            <br><br>
                            <br>
                            <div class="form-group mb-1  col-md-12 col-xs-12 col-sm-12 col-lg-12">
                                ...
                                ?>
                                <textarea class="form-control card-title parrafo text-black " id="conclusiones" style="border: 1px solid #cdcdcd;" name="conclusiones" rows="4" cols="120"><?php echo $actividad; ?></textarea>
                            </div>
                            <br>
                        </div>
                        </div>
