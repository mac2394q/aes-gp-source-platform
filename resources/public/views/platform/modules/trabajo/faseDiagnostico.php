                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="form-section"><i class="fa fa-business-time"></i>
                                    FASE DE DIAGNÓSTICO</h2>
                                <br>
                                <h4 class="card-title parrafo">Nota : Una vez termine el proceso de diagnóstico, por favor hacer clic en <code>
                                        |FINALIZAR
                                        DIAGNÓSTICO| </code> </h4>
                                <br>
                               
                                <div class="form-group ">
                                    <a id="finalizarDiagnosticoProyecto"
                                        class="btn capa round text-white waves-effect waves-light text-white"> <i
                                            class="fa fa-clipboard-check fa-2x"></i>&nbsp; FINALIZAR DIAGNÓSTICO </a>
                                </div>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <?php echo trabajoController::plantillaDiagnosticoProyectoListado($_GET['idproyecto']); ?>
                                <br>
                            </div>
                        </div>
                    </div>
