                        ...
                        <div class="card" style="">
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <div class="form">
                                        <h2 class="form-section"><i class="fa fa-id-card-alt fa-2x"></i>
                                            Gestión Proyecto - Fase Implementación
                                        </h2>
                                        <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group row mx-auto">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <button
                                                                ...
                                                                id="subirPlaneacionImplementacion">
                                                    ...
                                                    <div class="form-group row mx-auto last">
                                                        <div class="col-md-9">
                                                           <?php
                                                           if(rutas::validarRutas( DOCUMENTS_SERVER."documentos/trabajo/".$_GET['id']."/planeacion_implementacion.pdf") == "200"){
                                                            echo " <div class='badge badge-success round'>Archivo Cargado</div>";
                                                           }
                                                    
                                                           ?>
                                                            <a target="_blank"
                                                                href="<?php echo DOCUMENTS_SERVER."documentos/trabajo/".$_GET['id']."/planeacion_implementacion.pdf"; ?>"
                                        ...
                                        <?php if($_SESSION['rol'] == "ADMINISTRADOR" || $_SESSION['rol'] == "LIDER OEA" || $_SESSION['rol'] == "ASISTENTE" ){ ?>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <?php 
                                                        usuarioController::listadoUsuariosEspecialistasImpl($objTrabajo->getId_usuario_implementacion(),$_GET['id']);
                                                    ?>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <button type="button" id="asignarUsuarioImplementacion"
                                            ...
                                            <br>
                                            <div class="col-md-12">
                                            <?php  if(!is_null($objTrabajo->getId_usuario_implementacion())){
                                                $objEmpleado =usuarioController::usuarioId($objTrabajo->getId_usuario_implementacion());
                                                ?>
