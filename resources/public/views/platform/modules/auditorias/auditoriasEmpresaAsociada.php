      ...
      <div class="content-header-dark bg-img col-12">
        <div class="row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <h3 class="content-header-title "><i class="fa fa-mail-bulk"></i> MODULO DE AUDITORIAS</h3>
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active">Listado de auditorias como asociada de negocio</li>
                </ol>
              </div>
            </div>
          </div>
