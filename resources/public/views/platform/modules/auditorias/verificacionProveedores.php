                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <h1 class="form-section"><i class="fa fa-business-time"></i>
                                            INFORME AUDITORIA VERIFICACION DE PROVEEDORES EN EL EXTERIOR </h1>
                                        <br>
                                        <div id="top_bar2">
                                        ...
                                        <div class="row">
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                ...
                                                <textarea class='form-control ' id='objetivo_auditoria'
                                                    style="border: 1px solid #888;" name='objetivo_auditoria' rows='4' cols='120'> 
                                                    <?php echo "".trim($objAuditoria->getObjetivo_auditoria()); ?>
                                                </textarea>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                ...
                                                <br><br>
                                                <textarea class='form-control ' id='observacion_auditoria'
                                                    style="border: 1px solid #888;" name='observacion_auditoria' rows='4' cols='120'>
                                                    <?php echo $objAuditoria->getObservacion_auditoria();  ?>
                                                </textarea>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                ...
                                                <br><br>
                                                <textarea class='form-control ' id='descripcion_auditoria'
                                                    style="border: 1px solid #888;" name='descripcion_auditoria' rows='4' cols='120'>
                                                    <?php echo $objAuditoria->getDescripcion_auditoria();  ?>
                                                </textarea>
                                            </div>
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                <label for='projectinput3'>
                                            ...
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                ...
                                                <br><br>
                                                <textarea class='form-control ' id='descripcion_condiciones_entorno_auditoria'
                                                    style="border: 1px solid #888;" name='descripcion_condiciones_entorno_auditoria' rows='4' cols='120'>.
                                                    <?php echo $objAuditoria->getDescripcion_condiciones_entorno_auditoria();  ?>
                                                </textarea>
                                            </div>
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                <label for='projectinput3'>
                                                ...
                                                <br><br>
                                                <textarea class='form-control ' id='descripcion_condiciones_seguridad'
                                                    style="border: 1px solid #888;" name='descripcion_condiciones_seguridad' rows='4' cols='120'>
                                                    <?php echo $objAuditoria->getDescripcion_condiciones_interna_auditoria();  ?>
                                                </textarea>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                ...
                                                <textarea class='form-control ' id='actividades'
                                                    style="border: 1px solid #888;" name='actividades' rows='4' cols='120'><?php echo $objAuditoria->getActividades_auditoria();  ?>
                                                </textarea>
                                            </div>
                                        </div>
                                        <h3 class="form-section">
                                        ...
                                        <div class="row">
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                ...
                                                <br><br>
                                                <textarea class='form-control ' id='comentarios_auditor'
                                                    style="border: 1px solid #888;" name='comentarios_auditor' rows='4' cols='120'><?php echo $objAuditoria->getConclusion_auditoria();  ?>
                                                </textarea>
                                            </div>
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                <label for='projectinput3'>
                                                ...
                                                <br><br>
                                                <textarea class='form-control ' id='recomendacion_auditor'
                                                    style="border: 1px solid #888;" name='recomendacion_auditor' rows='4' cols='120'><?php echo $objAuditoria->getRecomendacion_auditoria() ;  ?>
                                                </textarea>
                                            </div>
                                            <br><br><br>
                                            <div class="col-md-12">
