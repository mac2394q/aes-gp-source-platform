                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Proceso de plan accion
                                        </li>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="form-section"><i class="fa fa-business-time"></i>
                                            Plantilla PVP</h2>
                                        <br>
                                        <h4 class="card-title">Nota : Auditor la opcion de <code> |VALIDAR PLAN DE ACCION| </code> si y solo si  todas las rubricas de plan de accion fueron evaluadas y chequeadas  correctamente. </h4>
                                        <br>
                                        <div class="form-group ">
											<a  id="" class="btn capa text-white waves-effect waves-light text-white">  <i class="fa fa-clipboard-check fa-2x"></i>&nbsp; Validar plan de accion</a>
                                        </div>
                                        <br>
                                        <div class="form-group ">
