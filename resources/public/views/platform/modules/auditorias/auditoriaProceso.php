                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Proceso de auditoria
                                        </li>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="form-section"><i class="fa fa-business-time"></i>
                                            Plantilla PVP</h2>
                                        <br>
                                        <h4 class="card-title">Nota : Para el auditor la opcion de <code> |FINALIZAR AUDITORIA| </code> si y solo si  todas las rubricas fueron evaluadas y chequeadas  correctamente. </h4>
                                        <br>
                                        <div class="form-group ">
											<a  id="finalizarAuditoria" class="btn capa text-white waves-effect waves-light text-white">  <i class="fa fa-clipboard-check fa-2x"></i>&nbsp; FINALIZAR AUDITORIA</a>
                                        </div>
                                        <br>
                                        <div class="form-group ">
