            ...
            <div class="content-header-dark bg-img col-12">
                <div class="row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <h3 class="content-header-title">Auditorias</h3>
                            ...
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel16">Verificacion de disponibilidad
                                            para programacion de auditoria</h4>
                                        ...
                                        <div class="form">
                                            <div class="form-body">
                                                    ...
                                                    <div class=" col-md-2">
                                                        <div class="form-group"><br>
                                                            <button class="btn capa text-white" type="button"
                                                                id="calendarioAuditor" data-toggle="modal"
                                                                data-target="#xlarge">
                                                ...
                                                <div class="form-actions">
                                                    <button class="btn capa text-white" id="registrarAuditoria">
                                                        <i class="la la-check-square-o"></i> crear Auditoria
                                                    </button>
                                                    <br>
                                                    <hr>
