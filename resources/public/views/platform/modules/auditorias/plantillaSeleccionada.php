                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Proceso de seleccion de rubrica evaluadas
                                        </li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <h4 class="card-title">Nota : Por defecto todas las rubricas estan seleccionadas ,si elige  deseleccionar la rubrica no aparece para ser evaluada</h4>
