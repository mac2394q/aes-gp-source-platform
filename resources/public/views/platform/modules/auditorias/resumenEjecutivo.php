...
2. Ejecución de auditoria de verificación Requisitos mínimos de seguridad del operador económico autorizado en Colombia de acuerdo resolución 000015 del 17 de Febrero del 2016. :
     ...
     * Recorrido a las instalaciones para verificacion de controles de sistema de seguridad electronica, controles de ingreso de visitantes, controles y demarcación de zonas criticas.
...
3. Reunión de cierre de la auditoria de verificación Requisitos mínimos de seguridad del operador económico autorizado en Colombia de acuerdo resolución 000015 del 17 de Febrero del 2016
                                            ...
                                            <div class='form-group mb-1 col-sm-12 col-md-12'>
                                                ...
                                                <br><br>
                                                <textarea class='form-control ' id='textarea'
                                                    style="border: 1px solid #888;" name='textarea' rows='4' cols='120'>.Aspectos relevantes positivos: La compañia cuenta con un sistema de gestion certificado con ISO 9001 y un sistema de seguridad en la cadena de suministro certificado con la norma ISO 28001 con la firma certificadora AES, esto permite un nivel de organización y gestión que evidencia el compromiso de la Alta Gerencia lo que les ha permitido mantenerse en el tiempo y lograr una cartera de clientes importantes y reconocidos en el Valle del Cauca.
...
1. Ejecucion de visitas bienales a los asociados de negocio.
