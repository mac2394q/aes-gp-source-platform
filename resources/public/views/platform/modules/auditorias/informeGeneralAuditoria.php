                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Informe general de auditoria
                                        </li>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="form-section"><i class="fa fa-business-time"></i>
                                            Informe General de Auditoria</h2>
                                        <br>
                                        <h4 class="card-title">Nota : este informe presenta las observacion del <code> AUTODIAGNOSTICO </code> de la empresa como las observaciones realizadas por el <code>AUDITOR</code> si este al evaluar las rubricas seleccionadas encuentra incidencias . </h4>
                                        <br>
