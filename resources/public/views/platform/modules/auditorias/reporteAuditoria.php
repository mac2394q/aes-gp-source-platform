                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <br>
                                        <h4 class="card-title">Nota : este informe es genero durante el proceso de auditoria <code> la emprea auditada </code> puede leer las observacion puesta por el auditor en caso de que encuentre anomalias o incidencias en el proceso. </h4>
