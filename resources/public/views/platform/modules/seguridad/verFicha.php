            ...
            <div class="content-header-dark bg-img col-12">
                <div class="row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <h3 class="content-header-title">Modulo gestion de seguridad</h3>
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Listado de certificaciones</a>
                                    </li>
                                    <li class="breadcrumb-item active">Registro de validacion para empresa y representante
                                    </li>
                                </ol>
                            </div>
                        </div>
