            ...
            <div class="content-header-dark bg-img col-12">
                <div class="row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <h3 class="content-header-title">Modulo Usuarios</h3>
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Listado de usuarios</a>
                                    </li>
                                    <li class="breadcrumb-item "><a href="<?php echo "verFicha.php?id=".$idempleado; ?>">Fichero empleado</a>
                                    </li>
                                    <li class="breadcrumb-item active">Foto perfil
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="bordered-layout-basic-form">Foto de perfil del empleado</h4>
                                        ...
                                        <form class="form form-horizontal form-bordered">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="button" id="subirFileV1"
                                                    class="btn capa btn-success waves-effect waves-light">
                                                    <i class="la la-check-square-o"></i> Cambiar foto perfil
                                                </button>
                                                &nbsp;
                                                &nbsp;
                                                &nbsp;
