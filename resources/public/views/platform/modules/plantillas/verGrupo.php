                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active parrafo text-black"><a class="text-black"
                                            href="<?php echo "verFicha.php?id=".$objGupo->getId_plantilla_alcance(); ?>">Plantilla
                                            y Capítulos</a>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="form-section"><i class="fa fa-sort-numeric-up fa-2x"></i>
                                            Capítulo de la Plantilla</h2>
                                        <a href="<?php echo "agregarElementos.php?id=".$objGupo->getId_plantilla_alcance();?>"
                                            class="btn text-white capa btn-sm round"><i
                                                class="fa fa-folder-plus fa-2x"></i>&nbsp;
                                            Agregar Requisito</a>
                                                        ...
                                                        <form class="form row">
                                                            ...
                                                            <div class="form-group mb-1 col-sm-12 col-md-4">
                                                                ...
                                                                <input type="text" id="projectinput3"
                                                                    class="form-control" placeholder=". . . "
                                                                    name="titulo"
                                                                    value="<?php  echo $objGupo->getTitulo_grupo_plantilla() ;    ?>">
                                                            </div>
                                                            <div class="form-group col-sm-12 col-md-2 text-center mt-2">
                                                                <button type="button" id="editarGrupo"
                                                                    class="btn text-white capa waves-effect waves-light round">
