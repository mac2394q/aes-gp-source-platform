                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active parrafo text-black">Registro de Plantilla
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <div class="form">
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <?php alcanceController::listadoAlcanceSelect(); ?>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                            ...
                                            <div class="repeater-default">
                                                        ...
                                                        <form class="form row">
                                                            ...
                                                            <div class="form-group col-sm-12 col-md-2 text-center mt-2">
                                                                <button type="button" id="eliminarCertificado"
                                                                    ...
                                                                    data-repeater-delete=""> <i class="fa fa-ban"></i>
                                                                    Eliminar</button>
                                                            </div>
                                                            <br>
                                                        </form>
                                                ...
                                                <div class="form-actions">
                                                    <button
                                                        ...
                                                        id="registrarPlantilla">
                                                        <i class="fa fa-check fa-2x"></i> &nbsp;Validar Plantilla
                                                    </button>
                                                    &nbsp;
                                                    &nbsp;
                                                    &nbsp;
                                                    <button
                                                        class="btn capa round btn-danger  waves-effect waves-light"
