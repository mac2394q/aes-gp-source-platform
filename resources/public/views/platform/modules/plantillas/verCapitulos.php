                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item parrafo"><a class="text-black" href="<?php echo "verFicha.php?id=".$objPlantilla->getId_plantilla_alcance(); ?>">Plantilla y  Capítulos</a>
                                        </li>
                                        <li class="breadcrumb-item active parrafo text-black">Requisitos del Capítulo
                                        </li>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly type="text" id="projectinput4"
                                                                    class="form-control" placeholder=". . . "
                                                                    name="pais" id="pais"
                                                                    value="<?php echo $objPlantilla->getTitulo_grupo_plantilla();?>">
                                                            </div>
                                                        </div>
