                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item parrafo"><a class="text-black" href="<?php echo "verFicha.php?id=".$_GET['id']; ?>">Plantilla y  Capítulos </a>
                                        </li>
                                        <li class="breadcrumb-item active parrafo text-black">Agregar Requisito 
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                    ...
                                                    <div  style="">
                                                        ...
                                                        <form class="form row">
                                                            <div class="form-group mb-1 col-sm-12 col-md-4">
                                                                <?php plantillaController::listadoGrupoPlantilla($objPlantilla->getId_plantilla_alcance()); ?>
                                                            </div>
                                                            <div class="form-group mb-1 col-sm-12 col-md-4">
                                                            ...
                                                            <div class="form-group col-sm-12 col-md-2 text-center mt-2">
                                                                <button type="button" id="registrarPlantillaGrupo"
                                                                    class="btn text-white round  capa waves-effect waves-light">  <i class="fa fa-save fa-2x"></i> Agregar Requisito</button>
                                                            </div>
