                        ...
                        <div class="row breadcrumbs-top">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item parrafo"><a class="text-black" href="grupos.php">Listado</a>

                                    </li>

                                    <li class="breadcrumb-item active parrafo ">Crear Grupo Empresarial
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label for="projectinput1">
                                                                    ...
                                                                    <h5 class="card-title"><span
                                                                            ...
                                                                            class="text-danger">*</span>Etiqueta de Referencia
                                                ...
                                                <div class="form-actions">
                                                    ...
                                                    <button class="btn capa text-white round" id="registrarGrupo">
