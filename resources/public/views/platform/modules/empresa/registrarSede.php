                            ...
                            <div class="row breadcrumbs-top">
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item parrafo"><a href="verFicha.php?id=">Folio empresa</a>
                                        </li>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly type="text" id="projectinput1"
                                                                    ...
                                                                    name="fname" value="<?php echo $idempresa->getNombre_empresa(); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly type="text" id="projectinput3"
                                                                    class="form-control card-title" placeholder=". . . "
                                                                    name="email" value="<?php echo $idempresa->getIdarea_tecnica_empresa(); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly type="text" id="projectinput3"
                                                                    class="form-control card-title" placeholder=". . . "
                                                                    name="email" value="<?php echo $idempresa->getCiudad_principal_empresa(); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input readonly type="text" id="projectinput4"
                                                                    ...
                                                                    name="phone" value="<?php echo $idempresa->getPais_empresa(); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <br><br>
                                        ...
                                        <div class="card-body">
                                            <div class="repeater-default">
                                                        ...
                                                        <form class="form row">
                                                            ...
                                                            <div class="form-group col-sm-12 col-md-2 text-center mt-2">
                                                                <button type="button"
                                                                    ...
                                                                    data-repeater-delete=""  id="eliminarCertificado"> <i class="ft-x"></i>
                                                                    Eliminar</button>
                                                            </div>
                                                        </form>
                                                        <hr>
                                                ...
                                                <div class="form-actions">
                                                    ...
                                                    <button  class="btn btn-success" id="registrarSede">
                                                        <i class="la la-check-square-o"></i> Asociar sede a empresa
                                                    </button>
                                                    <br><br>
                                                    <div id="smgEmpresa">
                                                    </div>
