...
class seguridadController
{
        ...
        echo   "<table id='project-task-list' class='table table-responsive-md table-white-space table-bordered row-grouping display no-wrap icheck table-middle dataTable'
                    ...
                    <thead>
                        <tr role='row'>
                            ...
                            <th class='sorting_disabled' rowspan='1' colspan='1' ><li class='fa fa-chart-line'></li> Descripcion
                            </th>
    ...
    public static function listadoCertificados2($tipo){
      ...
      if($objArea != false){
          echo "  <label for=''><h5 class='card-title'><li class='fa fa-clipboard-list'></li> <span class='text-danger'>*</span> Certificacion:</h5></label>
                  <br><br>
