...
class empresaController
{
    ...
    public static function ultimaGrupoRegistrada(){
        return empresaDao::ultimaGrupoRegistrada();
    }
    ...
    public static function autenticacionEmpresa($usuario,$clave,$idusuario){
        return empresaDao::autenticacionEmpresa($usuario,$clave,$idusuario);
    }
    public static function objEmpresa($idempresa){
        return empresaDao::empresaId($idempresa);
    }
    public static function objEmpresaIdUsuario($idempresa){
        return empresaDao::objEmpresaIdUsuario($idempresa);
    }
    ...
    public static function grupoEmpresarialIdUsuario($id){
        return empresaDao::grupoEmpresarialIdUsuario($id);
    }
    ...
    public static function listadoSimpleEmpresas($consulta,$orden){
        $objEmpresa=empresaDao::listadoSimpleEmpresas($consulta,$orden);
        //print_r($objEmpresa);
        if($objEmpresa!= false){
        echo   "<table id='project-task-list' class='table table-responsive-md table-white-space table-bordered row-grouping display no-wrap icheck table-middle dataTable'
                    ...
                    <thead>
                        <tr role='row'>
                            ...
                            <th class='titulo' rowspan='1' colspan='1' ><li class='fa fa-shield-alt'></li>  Sesión
                            </th>
                            ...
                            <th class='titulo' rowspan='1' colspan='1' ><li class='fa fa-globe'></li>  Ciudad - Departamento
                            </th>
                            <th class='titulo' rowspan='1' colspan='1' ><li class='fa fa-globe'></li>  Naturaleza
                            </th>
                            <th class='titulo' rowspan='1' colspan='1' ><li class='fa fa-globe'></li>  Representante
                            </th>
                            <th class='titulo' rowspan='1' colspan='1' ><li class='fa fa-globe'></li>  Fecha de Registro
                            </th>
                    ...
                    <tbody>
                        ...
                        foreach ($objEmpresa as $key => $value) {
                            // print_r($objEmpresa[$key]);
                            // echo "<br><br><br>";
                        echo"
                        <tr role='row' class='even'>
                            <td><a href='".MODULE_APP_SERVER."empresa/verFicha.php?id=".$objEmpresa[$key]->getId_entidad()."' class='dropdown-item'><i class='fa fa-eye fa-2x'></i> </a></td>
                            <td><a href='".MODULE_APP_SERVER."empresa/autentificacionEmpresa.php?id=".$objEmpresa[$key]->getId_entidad()."' class='dropdown-item'><i class='fa fa-key fa-2x'></i> </a></td>
                            <td class='parrafo'>
                            
                            <a href='".MODULE_APP_SERVER."empresa/verFicha.php?id=".$objEmpresa[$key]->getId_entidad()."' class='dropdown-item'>".$objEmpresa[$key]->getIdentificacion_empresa()."</a>
                            ...
                            <td class='parrafo'>
                              ".$objEmpresa[$key]->getCiudad_empresa()." - ".$objEmpresa[$key]->getDepartamento_empresa()."
                            </td>
                            <td class='parrafo'>
                              ".$objEmpresa[$key]->getNaturaleza_empresa()."
                            </td>
                            <td class='parrafo'>
                              ".$objEmpresa[$key]->getNombre_representate_empresa()."
                            </td>
                            <td class='parrafo'>
                              ".$objEmpresa[$key]->getFecha_registro_empresa() ."
                            </td>";
    ...
    public static function listadoSimpleEmpresasAsociar($idempresa){
        ...
        echo   "<table id='project-task-list' class='table table-responsive-md table-white-space table-bordered row-grouping display no-wrap icheck table-middle dataTable'
                    ...
                    <tbody>
                        ...
                        <tr role='row' class='even'>
                            <td class='parrafo'>
                              ".$objEmpresa[$key]->getIdentificacion_empresa()."
                            </td>
                            <td class='parrafo'>
                              ".$objEmpresa[$key]->getNombre_empresa()."
                            </td>
                            ...
                            //<td><a href='".MODULE_APP_SERVER."auditorias/auditoriasEmpresaAsociada.php?id=".$idempresa."&id2=".$objEmpresa[$key]->getId_entidad()."' class='btn capa text-white'><i class='fa fa-book-open fa-2x'></i> </a></td>
                            echo "
                            
                            <td><a href='".MODULE_APP_SERVER."auditorias/auditoriasEmpresa.php?id=".$idempresa."' class='btn capa text-white'><i class='fa fa-book-open fa-2x'></i> </a></td>
                            <td><a href='".MODULE_APP_SERVER."empresa/core/desasociarEmpresa.php?id=".$idempresa."&id2=".$objEmpresa[$key]->getId_entidad()."' class='btn btn-danger'><i class='fa fa-minus-circle fa-2x'></i> </a></td>
                        </tr>";
                        }
                        echo"
                    </tbody>
    ...
    public static function listadoSimpleGrupos($consulta){
      $objEmpresa=empresaDao::listadoGrupoEmpresarial($consulta);
      //print_r($objEmpresa);
      if($objEmpresa!= false){
      echo   "<table id='project-task-list' class='table table-responsive-md table-white-space table-bordered row-grouping display no-wrap icheck table-middle dataTable'
                      role='grid' aria-describedby='project-task-list_info' style='position: relative;'>
                  <thead>
                      <tr role='row'>
                          ...
                          <th class='titulo' rowspan='1' colspan='1' ><li class='fa fa-globe'></li>  Número de empresas
                          </th>
                  ...
                  <tbody>
                      ...
                      <tr role='row' class='even'>
                          <td class='parrafo'><a href='verFichaGrupo.php?id=".$objEmpresa[$key]->getId_entidad()."' class='dropdown-item'><i class='fa fa-eye fa-2x'></i> </a></td>
                          <td class='parrafo'>
                             ".$objEmpresa[$key]->getNombre_grupo_empresarial()."
                          </td>
                          <td class='parrafo'>
                            ".empresaDao::nEmpresasGrupoEmpresarial($objEmpresa[$key]->getId_entidad())."
                          </td>
                          <td class='parrafo'>
  ...
  public static function listadoEmpresas($idempresa){
    ...
    if($objplantilla != false){
        ...
        echo "  <label for=''><h5 class='card-title'><li class='fa fa-clipboard-list'></li> <span class='text-danger'>*</span>Empresa :</h5></label>
                <select id='empresaA' name='empresaA' class='form-control'>
                ";                
        foreach ($objplantilla as $key => $value) {     
            echo    "<option value='".$objplantilla[$key]->getId_entidad()."'>
  ...
  public static function listadoEmpresaSedes($idempresa){
            ...
            <div  style=''>
                <form class='form row'>
                    <div class='form-group mb-1  col-md-8'>
                        <label for=''><span
                                class='text-danger'>Actualmente la empresa no posee certificado vigentes</span></label>
                        <br>
                    </div>
    ...
    public static function listadoDocumentosEmpresaValidacion($idempresa,$empresa){
        ...
        if($objCertificados != false){
            ...
            $url = DOCUMENTS_SERVER."documentos/empresa/".$_GET['id']."/".$objCertificados[$key]->getidempresa_asignacion()."_".$objCertificados[$key]->getidvalidacion_empresa().".pdf";
            ...
            <div class='form-group mb-1 col-sm-12 col-md-2'>
                ...
                <input type='date' id='projectinput3'
                    class='form-control' placeholder='. . . '
                    name='contacto' value='".$objValidacion->getfecha_registro_validacion_empresa()."'>
            </div>
            <div class='form-group mb-1 col-sm-12 col-md-2'>
                <label for='projectinput3'><span
                        class='text-danger'>*</span>
                    </span> Documento </label><br><br>
                <input type='text' id='projectinput3'
                    class='form-control' placeholder='. . . '
            ...
            <div class='form-group mb-1 col-sm-12 col-md-2'>
                ...
                <br><br>
                <a href='".$url."' class='btn btn-warning'>VER ADJUNTAR</a>
            </div>
