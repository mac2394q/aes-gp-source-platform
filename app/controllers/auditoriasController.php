		...
		echo   "<table  class='table table-bordered table-responsive-lg'
					...
					<thead>
						...
						<th  ><li class='fa fa-cog'></li>  Acciones
							...
							<th  ><li class='fa fa-barcode'></li> Empresa Ancla</th>
							<th  ><li class='fa fa-money-check'></li>  Asociada de negocio 
							</th>
							<th  ><li class='fa fa-globe'></li>  Fecha auditoria
							</th>
							<th  ><li class='fa fa-warehouse'></li>  Auditor
							</th>
							<th  ><li class='fa fa-chart-line'></li>  Plantilla
		...
		if($GrupoPlantilla != false){
		    ...
		    foreach ($GrupoPlantilla as $key => $value) {  
		     ...
		     echo   "<table id='' class='table table-responsive-md table-white-space table-bordered row-grouping display no-wrap icheck table-middle dataTable'
					...
					<thead>
						<tr role='row'>
							<th class='sorting_disabled'  ><li class='fa fa-folder-open'></li>  Titulo
							</th>
							<th class='sorting_disabled'  ><li class='fa fa-file-alt'></li>  Descripción
							</th>
							
							<th class='sorting_disabled' ><li class='fa fa-file-alt'></li> Autodiagnóstico  de la Empresa
							</th>
														...
														echo"
															<div class='form-group col-sm-12 col-md-2 text-center mt-2'>
																<a  href='#".$GrupoPlantilla[$key]->getIdauditoria_item()."' title='".$GrupoPlantilla[$key]->getIdauditoria_item()."' id='validarElemento2'
																	class='btn capa text-white waves-effect waves-light'>  <i class='fa fa-save fa-2x'></i>&nbsp Validar</a>
															</div>
															<div class='form-group col-sm-12 col-md-6 text-center mt-2'>
					...
					<tbody>";
						...
						<tr role='row' class='even'>
							...
							if($GrupoPlantilla[$key]->getEstado_auditoria_item() == 0){
								echo "<td class='reorder sorting_1'><a href='core/seleccionar.php?iditem=".$GrupoPlantilla[$key]->getIdauditoria_item()."&idauditoria=".$GrupoPlantilla[$key]->getIdauditoria() ."' class='dropdown-item'><i class='fa fa-minus-circle fa-2x'></i> </a></td>";
								
							}else{
								echo "<td class='reorder sorting_1'><a href='core/noSeleccionar.php?iditem=".$GrupoPlantilla[$key]->getIdauditoria_item()."&idauditoria=".$GrupoPlantilla[$key]->getIdauditoria() ."' class='dropdown-item'><i class='fa fa-check fa-2x'></i> </a></td>";
											...
											<form class='form row'>
												...
												<div class='form-group col-sm-12 col-md-1 text-center mt-2'>
													<a  href='".$dir."' title='' id='' target='_blank'
																	class='btn capa text-white waves-effect waves-light'>  <i class='fa fa-file-pdf fa-2x'></i>&nbsp; PDF</a>
												</div>
